#define INTERVAL_SENSOR   1700             //定义传感器采样时间间隔  597000
#define INTERVAL_NET      1700             //定义发送时间
//传感器部分================================   
#include "U8glib.h"
...
#define SSID           "CMCC-1313"                   // cannot be longer than 32 characters!
#define PASSWORD       "WZZQFygyzd"
...
//WEBSITE     
#define HOST_NAME    "192.168.1.13"             //可改成自己的服务器地址和端口
